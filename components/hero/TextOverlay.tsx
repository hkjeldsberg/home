...
export default function TextOverlay() {
  ...
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 10, pointerEvents: "none", userSelect: "none" }}>
      <animated.div style={{ ...fadeIn, width: "100%", height: "100%" }}>
        ...
        <div style={{ position: "absolute", top: "2rem", right: "2rem", display: "flex", gap: "1.25rem", pointerEvents: "auto" }}>
          <a
        ...
        {/* Mission statement — bottom center */}
      </animated.div>
    </div>
  );
}
